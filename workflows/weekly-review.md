...
| 5 | Re-check provisional rules | `trade-journal-postmortem` | Replay the closed-trade log against each `provisional:` rule in the constants file; demote any that fail the back-check. |
